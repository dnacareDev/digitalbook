...
@Component("resultExcelView")
@RequiredArgsConstructor
public class ResultExcelView extends AbstractXlsView {
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		int plan_step = (int) model.get("plan_step");
		
		List<Plan> plans = mapper.selectResultExcelList(user_group, plan_step);
		
		Sheet sheet = workbook.createSheet("결과입력");
